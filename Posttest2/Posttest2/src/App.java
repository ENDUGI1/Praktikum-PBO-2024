        ...
        while (pilih != 5) {
            ...
            switch (pilih) {
                ...
                case 3:
                    ...
                    dataBarang.get(ubah - 1).setNama(sc.nextLine());

                    System.out.println("Masukkan Jenis Barang Baru");
                    dataBarang.get(ubah - 1).setJenisBarang(sc.nextLine());

                    System.out.println("Masukkan Harga Baru");
                    dataBarang.get(ubah - 1).setHarga(sc.nextInt());

                    System.out.println("Masukkan Stok Baru");
                    dataBarang.get(ubah - 1).setStok(sc.nextInt());
